...
class CostService:
    ...
    @staticmethod
    def calculate_from_usage_summary(usage_summary: Any, session_duration: int) -> Optional[Dict[str, Any]]:
        """
        ...
        try:
            ...
            llm_input_cost = (llm_prompt_tokens / 1000) * CostService.AZURE_OPENAI_INPUT_PER_1K
            llm_output_cost = (llm_completion_tokens / 1000) * CostService.AZURE_OPENAI_OUTPUT_PER_1K
