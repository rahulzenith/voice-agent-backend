...
class SharedState:
    ...
    def __init__(self):
        ...
        self.session: Optional[Any] = None  # Store the AgentSession (for chat context access)
        self.usage_collector: Optional[Any] = None  # LiveKit UsageCollector for metrics-based cost tracking
        ...
        self.user_preferences: Dict[str, Any] = {}  # Track preferences mentioned during conversation
